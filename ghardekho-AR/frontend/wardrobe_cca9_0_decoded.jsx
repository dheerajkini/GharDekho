...
<truncated 5489 bytes>","StartLine":"297","TargetContent":""function Wardrobe({ w, d, color, sel }) {
  const h = 2.0;
  const c = sel ? "#55efc4" : color;
  return (
    <group>
...
The following code has been modified to include a line number before every line, in the format: <line_number>: <original_line>. Pl